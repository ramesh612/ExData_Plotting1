...
png("plot4.png") # width and height default to 480

## 2 rows and 2 columns in our plot
par(mfrow=c(2,2))

# top left
with(data, plot(data$Global_active_power ~ data$DateTime, xlab="", type="l", 
                ylab="Global Active Power"))
# top right
with(data, plot(data$Voltage ~ data$DateTime, type="l", xlab="datetime", 
                ylab="Voltage"))

# bottom left
plot(data$Sub_metering_1 ~ data$DateTime,  xlab="", type="l", 
     ylab="Energy sub metering")
lines(data$Sub_metering_2~data$DateTime, col = "red")
lines(data$Sub_metering_3~data$DateTime, col = "blue") 
legend("topright", cex = 1, col = c("black", "red", "blue"), lwd = 1, bty = "n",
       y.intersp = 1, xjust = 1, text.width = strwidth("Sub_metering_1"), 
